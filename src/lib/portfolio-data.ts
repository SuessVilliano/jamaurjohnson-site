...
export const ABOUT = {
  ...
  intro: [
    "Born and raised in Wilmington, Jamaur Johnson grew up blending leadership, athletics, and ambition. A standout in the Caravel Academy yearbook — All-State wide receiver and the kind of presence teachers remembered — he earned a partial football scholarship to West Chester University before continuing his business studies through the University of Delaware and Wilmington University.",
    "After a stretch in the corporate world, he took the entrepreneurial leap more than a decade ago and never looked back. Since then he has lived as a digital nomad — Miami, Orlando, Tampa, Las Vegas, Atlanta — building brands, scaling online organizations, and mastering digital marketing, automation, and emerging technology. An early run in network marketing taught him leadership, systems-building, and community growth at scale, and became the foundation for the companies, platforms, and AI-driven ecosystems he builds today.",
    "Now operating under his own name in business, Suess Villiano in music, and META SV across his creative work, Jamaur is focused on the future: combining AI, automation, finance, media, and education into scalable businesses that empower people to think bigger, operate smarter, and create generational leverage. Whether through trading technology, AI systems, digital infrastructure, or entrepreneurial education, his work is rooted in one core belief — technology should enhance human potential, not replace it.",
  ],
  extended: [
    "He doesn't think in projects. He thinks in ecosystems. Hybrid Funding, Trade Hybrid, LIV8, LIV8AI, AI agents, trading automation, family trusts, education platforms, books, music — every piece is a thread in one larger fabric. Each one is a different form of the same idea: leverage. Financial, technological, informational, generational.",
    "Two energies move through everything he builds: the builder/operator who can architect a CRM, ship an AI agent, or take a prop firm from idea to infrastructure — and the visionary/philosopher who sees fifty futures at once and pulls them into the present. That combination is rare. It's what lets him hold an entire network of ideas in motion and turn them into systems other people can actually use.",
