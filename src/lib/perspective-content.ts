...
export const INSIGHTS_POSTS: InsightPost[] = [
  ...
  {
    slug: "systems-for-the-life-not-just-the-business",
    category: "Life Systems",
    title: "Systems For The Life, Not Just The Business",
    minutes: 6,
  ...
  {
    slug: "beyond-trading-the-long-arc-stack-of-real-wealth",
    category: "Investments",
    title: "Beyond Trading: The Long-Arc Stack Of Real Wealth",
    minutes: 7,
    publishedDate: "February 2026",
    summary:
      "Trading is one engine. It is not the whole stack. The operators who compound for decades own three layers — and most of them are quieter than the one everyone talks about.",
    body: [
  ...
  {
    slug: "stillness-is-strategy",
    category: "Spirituality",
    title: "Stillness Is Strategy",
    minutes: 5,
    publishedDate: "September 2025",
    summary:
      "Every discipline that matters — trading, building, leading, loving — rewards the same quiet skill that almost nobody is trained for. The people who develop it tend to look, after a while, like they got lucky.",
    body: [
  ...
  {
    slug: "sound-as-operating-system",
    category: "Music",
    title: "Sound As Operating System",
    minutes: 5,
    publishedDate: "June 2025",
    summary:
      "The frequencies you live inside shape the operator you become. Music is not a break from the work. It is the substrate the work runs on.",
    body: [
